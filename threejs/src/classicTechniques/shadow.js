...
const debugTweaks = {
  ...
  directionalLightPositionY: 1.68,
...
const tick = () => {
  ...
  sphere.position.x = Math.sin(elapseTime) * 5
  sphere.position.z = Math.cos(elapseTime) * 5
  sphere.position.y = Math.abs(Math.sin(elapseTime * 3)) * 3;
